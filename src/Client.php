...
final class Client
{
     ...
     */
    // @phpstan-ignore-next-line method.unused (wired up by the public endpoint methods added on top of this transport core; exercised directly via reflection in ClientTransportTest until then)
